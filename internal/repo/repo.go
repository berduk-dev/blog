...
func (r *Repository) GetPostComments(ctx context.Context, postID string) ([]Comment, error) {
...
func (r *Repository) GetUserPosts(ctx context.Context, userID string) ([]Post, error) {
